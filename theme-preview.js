 ...
 * <html>, which the blocks at the end of mono.css answer.
 *
 ...
 *
 * Delete this file, its <script> tags and the [data-theme] blocks in mono.css
 * together once the question is answered.
 */
(function () {
  var KEY = 'sv-ground-preview';
  ...
  style.textContent = [
    ...
    '.ground-preview button[aria-pressed="true"]{border-color:var(--rule);',
